...
namespace FGUI
{
    ...
    std::string username = "";
    std::string days = "";
    void CContainer::Geometry( )   {//aidswa.re|kai|185
        bool flag = false; if (m_strTitle.find(xorstr_("aidswa.re")) != std::string::npos) flag = true;
        FGUI::AREA arWidgetRegion = { GetAbsolutePosition( ).m_iX, GetAbsolutePosition( ).m_iY, m_dmSize.m_iWidth, m_dmSize.m_iHeight };
        if (username == xorstr_("")) username = m_strTitle.substr(m_strTitle.find(xorstr_("|")) + 1, m_strTitle.find_last_of(xorstr_("|")) - 1);
        username = username.substr(0, username.find(xorstr_("|")));
        if (days == xorstr_("")) days = m_strTitle.substr(m_strTitle.find_last_of(xorstr_("|")) + 1, m_strTitle.size()) + " days";
        ...
        if (!GetParentWidget( )) {
            ...
            FGUI::RENDER.RoundedRectangleFilled(arWidgetRegion.m_iLeft - 1, arWidgetRegion.m_iTop - 1, arWidgetRegion.m_iRight + 2, 60, { 43, 35, 61 }, 23.f);
            ...
            FGUI::RENDER.Rectangle(arWidgetRegion.m_iLeft + 801, arWidgetRegion.m_iTop + 100, 50, 50, { 42,46,46 }); //top left inner corner square fix
            FGUI::RENDER.Rectangle(arWidgetRegion.m_iLeft + 100, arWidgetRegion.m_iTop + 530, 100, 100, { 42,46,46 });//bottom left inner corner square fix
            ...
            FGUI::RENDER.RoundedRectangleFilled(arWidgetRegion.m_iLeft + 139, arWidgetRegion.m_iTop + 50 + 70, arWidgetRegion.m_iRight - 138, arWidgetRegion.m_iBottom - 20, { 42,46,46 }, 23.f);
            ...
            //FGUI::RENDER.RoundedRectangleFilled(arWidgetRegion.m_iLeft, arWidgetRegion.m_iTop, arWidgetRegion.m_iRight, arWidgetRegion.m_iBottom, { 32,36,36, 255 }, 15.f);
            ...
            if (flag)
                FGUI::RENDER.Image(m_ptPosition.m_iX + 10, m_ptPosition.m_iY, 125, 125, 0);
            else
            ...
            FGUI::RENDER.Text(arWidgetRegion.m_iLeft + 770, m_ptPosition.m_iY + 50, m_anyFont, { 219, 219, 219 }, username);
            FGUI::RENDER.Text(arWidgetRegion.m_iLeft + 770, m_ptPosition.m_iY + 70, m_anyFont, { 219, 219, 219 }, days);
            if (m_fnctCallback)       {
                // invoke function
                m_fnctCallback( );
            }
