...
namespace FGUI
{
  ...
  void CColorPicker::Geometry()
  {
    ...
    if (m_bIsOpened)
    {
      ...
      // color hsb body
      FGUI::RENDER.Outline((arColorPickerRegion.m_iLeft + arColorPickerRegion.m_iRight) + 1, (arColorPickerRegion.m_iTop + 1), 1, arColorPickerRegion.m_iBottom + 2, { 74, 110, 255 });
      ...
      // hue bar body
      FGUI::RENDER.Outline(((arColorPickerRegion.m_iLeft + arColorPickerRegion.m_iRight) + 10) - 1, arColorPickerRegion.m_iTop - 1, (10 + 2), arColorPickerRegion.m_iBottom + 2, { 74, 110, 255 });
      ...
      // alpha bar body
      FGUI::RENDER.Outline(((arColorPickerRegion.m_iLeft + arColorPickerRegion.m_iRight) + 30) - 1, arColorPickerRegion.m_iTop - 1, (10 + 2), arColorPickerRegion.m_iBottom + 2, { 74, 110, 255 });
